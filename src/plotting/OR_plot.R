...
all_odds_ratios <- rbind(odds_ratio_1_2, odds_ratio_1_3,
                        odds_ratio_2_2, odds_ratio_2_3,
                        odds_ratio_3_2, odds_ratio_3_3,
                        odds_ratio_5_2, odds_ratio_5_3)

# View results
all_odds_ratios

write.table(all_odds_ratios, sep = ",", file = "./output/2013-2022_approvals_v6_OR.csv", row.names = FALSE)
...
ggplot(df, aes(x = estimate, y = table_data)) +
  ...
  scale_x_log10(limits = c(0.2, 250)) +
  scale_y_discrete(expand = c(0.1, 0)) +
  labs(x = "Odds Ratio (log scale)", y = "", title = "2013-2022 approvals (onco vs non-onco)") +
  theme_bw() +
